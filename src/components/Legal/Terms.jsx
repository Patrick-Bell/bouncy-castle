...
const sections = [
    ...
    },
    {
        ...
        items: [
            "In the event of serious injury: call 999 immediately, do not move the injured person unless they are in immediate danger, administer first aid if trained to do so, and contact us on 07700 000 000.",
            ...
            "In the event of electrical fault: switch off and disconnect the power supply immediately, do not attempt to repair — contact us straight away on 07700 000 000.",
            ...
            "All incidents, near misses, and injuries must be reported to us within 24 hours by calling 07700 000 000 or emailing help@hazeevents.com so they can be recorded in our incident log.",
