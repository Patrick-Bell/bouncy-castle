import {
  ...
  const Banner = () => {
    return (
      <div className="hidden md:flex relative w-full flex-col items-center justify-center overflow-hidden primary-bg p-3">
        {/* First scrolling row */}
        <ScrollVelocityContainer className="text-sm font-bold tracking-[-0.02em] uppercase">
          <ScrollVelocityRow baseVelocity={3} direction={-1}>
            ...
            <span className="mx-2 text-primary">|</span>   {/* Separator */}
