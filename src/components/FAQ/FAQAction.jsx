...
const FAQAction = () => {
    ...
    return (
        ...
        <div className="primary-bg rounded-3xl p-10 mt-8 flex flex-col items-center text-center gap-5">
                    <span className="text-4xl"><BsQuestion className="primary-text w-15 h-15" /></span>
                    <h3 className="text-2xl lg:text-3xl font-extrabold primary-text">Have some more questions?</h3>
                    <p className="text-gray-400 text-sm max-w-md leading-relaxed">
                        If you have any more questions or need further assistance, please don't hesitate to reach out to us. We're here to help and ensure you have the best experience possible!
                    </p>
