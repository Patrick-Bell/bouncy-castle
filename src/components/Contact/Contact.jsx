      ...
      <section className="px-8 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            {/* Contact Methods */}
            <div className="bg-white rounded-3xl border border-[#d8dbca] p-8 flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3">
                ...
                <a href="https://wa.me/447700000000" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-4 p-4 rounded-2xl border border-[#d8dbca] hover:border-green-300 hover:bg-green-50 transition-all group">
                ...
                <a href="tel:+447700000000"
                  className="flex items-center gap-4 p-4 rounded-2xl border border-[#d8dbca] hover:border-[#3b3e33]/40 hover:bg-[#3b3e33]/5 transition-all group">
                  <div className="w-11 h-11 rounded-xl bg-[#3b3e33]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#3b3e33]/20 transition-colors">
                    <Phone className="w-5 h-5 primary-text" />
                  </div>
                  <div className="flex-1">
            ...
            <div className="bg-white rounded-3xl border border-[#d8dbca] p-8 flex flex-col gap-5">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-[#3b3e33]/10 flex items-center justify-center">
                  <Clock className="w-5 h-5 primary-text" />
                </div>
                <h3 className="font-extrabold text-gray-900 text-lg">Opening Hours</h3>
              </div>
              <div className="flex flex-col gap-3">
                {openingHours.map((row, i) => (
                  <div key={i} className="flex items-center justify-between py-3 border-b border-[#d8dbca] last:border-0">
                    <span className="text-sm font-semibold text-gray-700">{row.day}</span>
                    <span className="text-sm font-bold primary-text">{row.hours}</span>
                  </div>
                ))}
              </div>
              <div className="bg-[#f8f9f2] rounded-2xl p-4 mt-auto border border-[#d8dbca]">
          ...
          <div className="bg-[#f8f9f2] border border-[#d8dbca] rounded-3xl p-7 flex flex-col sm:flex-row gap-5 items-start sm:items-center mb-6">
            <div className="w-12 h-12 rounded-2xl bg-[#3b3e33]/10 flex items-center justify-center flex-shrink-0">
              <Truck className="w-6 h-6 primary-text" />
            </div>
            <div className="flex-1">
            ...
            <div className="flex-shrink-0 text-center bg-white rounded-2xl px-5 py-3 border border-[#d8dbca]">
              <p className="text-2xl font-extrabold primary-text">10mi</p>
          ...
          <div className="bg-white rounded-3xl border border-[#d8dbca] p-8 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {postcodeAreas.map((area, i) => (
                <div key={i} className="bg-[#f8f9f2] rounded-2xl p-4 flex flex-col gap-2.5 border border-[#d8dbca]">
                  <div className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 primary-text flex-shrink-0" />
                    <p className="font-bold text-sm text-gray-800">{area.area}</p>
                  </div>
                  <div className="flex flex-wrap gap-1.5">
                    {area.codes.map((code, j) => (
                      <span key={j} className="text-xs font-bold bg-white border border-[#d8dbca] text-gray-600 px-2 py-0.5 rounded-lg">
                        {code}
                      </span>
                    ))}
                  </div>
            ...
            <p className="text-xs text-gray-400 mt-6 text-center">
              Don't see your postcode? <a href="https://wa.me/447700000000" className="primary-text font-semibold hover:underline">Message us</a> — we may still be able to help depending on availability.
            </p>
          </div>
